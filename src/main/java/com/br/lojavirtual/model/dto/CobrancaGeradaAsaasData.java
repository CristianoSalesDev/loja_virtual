...
public class CobrancaGeradaAsaasData implements Serializable {
	...
	private CobrancaGeradaAsaasDiscount discont = new CobrancaGeradaAsaasDiscount();
	private CobrancaGeradaAsaasFine fine = new CobrancaGeradaAsaasFine();
	private CobrancaGeradaAsaasInterest interest = new CobrancaGeradaAsaasInterest();
	...
	public CobrancaGeradaAsaasDiscount getDiscont() {
		return discont;
	}

	public void setDiscont(CobrancaGeradaAsaasDiscount discont) {
		this.discont = discont;
	}

	public CobrancaGeradaAsaasFine getFine() {
		return fine;
	}

	public void setFine(CobrancaGeradaAsaasFine fine) {
		this.fine = fine;
	}

	public CobrancaGeradaAsaasInterest getInterest() {
		return interest;
	}

	public void setInterest(CobrancaGeradaAsaasInterest interest) {
