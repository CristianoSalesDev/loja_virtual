...
public class ObjetoEmissaoNotaFiscalWebMania implements Serializable {
	...
	public void setLogObject(Log logObject) {
		LogObject = logObject;
	}

	public boolean isEpec() {
		return epec;
	}

	public void setEpec(boolean epec) {
		this.epec = epec;
	}
